...
from .views import form_del_producto, form_producto, index, form_del_producto,form_mod_producto, signin, carrito, contactanos, crud, despacho, detalleproducto, perfil, signinadmin, signup, sobrenosotros,table
